...
function AdminDashboard({ user, onLogout }) {
  ...
  const tabs = {
    dashboard: { icon: '≡ƒôè', label: 'Dashboard' },
    students: { icon: '≡ƒæÑ', label: 'Student Records' },
    register: { icon: 'Γ₧ò', label: 'Register Student' },
    attendance: { icon: '≡ƒôï', label: 'Attendance Records' },
    faceauth: { icon: '≡ƒÄ¡', label: 'Face Auth Status' },
    geofence: { icon: '≡ƒîì', label: 'Geofence Config' },
    train: { icon: '≡ƒñû', label: 'Train Model' },
    profile: { icon: '≡ƒæñ', label: 'Profile' },
  };
        ...
        <header className="h-14 bg-white shadow-sm border-b border-gray-200 flex items-center justify-between px-4 lg:px-6 sticky top-0 z-30">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-300 hidden sm:inline">ΓÇ║</span>
